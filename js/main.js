...
$(document).ready(function () {
   ...
   if (linkOne) {
		...
		$('.text__paragrath-one').text("Each time she picked one she thought that she could see an even more beautiful one a little way off, and she ran after it, going further and further into the woods.");
      linkOne = false;
   } else {
		...
		$('.text__paragrath-one').text("SDon’t worry if your data is very large, the Data Warehoue provides a search engine, which is useful for making it easier to find data effectively saving time.");
		linkOne = true;
   }
	});
});
...
$(document).ready(function () {
   ...
   if (linkTwo) {
		...
		$('.text__paragrath-two').text("Each time she picked one she thought that she could see an even more beautiful one a little way off, and she ran after it, going further and further into the woods.");
      linkTwo = false;
   } else {
		...
		$('.text__paragrath-two').text("SDon’t worry if your data is very large, the Data Warehoue provides a search engine, which is useful for making it easier to find data effectively saving time.");
		linkTwo = true;
   }
	});
});
...
$(document).ready(function () {
   ...
   if (linkThree) {
		...
		$('.text__paragrath-three').text("Each time she picked one she thought that she could see an even more beautiful one a little way off, and she ran after it, going further and further into the woods.");
      linkThree = false;
   } else {
		...
		$('.text__paragrath-three').text("SDon’t worry if your data is very large, the Data Warehoue provides a search engine, which is useful for making it easier to find data effectively saving time.");
		linkThree = true;
   }
	});
});
...
$(document).ready(function () {
   ...
   if (linkFore) {
		...
		$('.text__paragrath-fore').text("Each time she picked one she thought that she could see an even more beautiful one a little way off, and she ran after it, going further and further into the woods.");
      linkFore = false;
   } else {
		...
		$('.text__paragrath-fore').text("SDon’t worry if your data is very large, the Data Warehoue provides a search engine, which is useful for making it easier to find data effectively saving time.");
		linkFore = true;
   }
	});
});
